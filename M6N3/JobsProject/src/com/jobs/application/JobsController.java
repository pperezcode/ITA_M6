...
public class JobsController {
	...
	public void createVolunteer(String name, String address, String phone, double governmentSubsidy) throws Exception{
		Volunteer volunteer = new Volunteer(name, address, phone, "¡Los voluntarios no cobran!", governmentSubsidy);
